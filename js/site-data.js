...
──────────────────────────────────────────────────────────────── */
var SITE_SEO = {
  coreWebVitals: { score: 98, lcp: '1.2s', inp: '62ms', cls: '0.02', grade: 'Good' },
  meta: [
...
var SITE_MARKETING = {
  strategy: {
    ...
    positioning: '일본어 전담 스탭 상주 + MEDIFLOW 서포트로 "불안 없는 한국 성형" 포지셔닝',
  ...
  keywords: {
    ...
    longTail: [
      { kw:'韓国 二重整形 日本語対応', aeoQ:['韓国の二重整形はいくらですか？','ソウルで日本語対応の整形外科は？'] },
      { kw:'江南 鼻フィラー 安い',     aeoQ:['鼻フィラーのダウンタイムは？','江南の整形外科おすすめは？'] },
      { kw:'ソウル 整形外科 アフターケア', aeoQ:['韓国整形のアフターケアは帰国後もできる？'] },
      { kw:'韓国 輪郭手術 モニター',    aeoQ:[] },
      { kw:'二重手術 韓国 費用',        aeoQ:['韓国の二重整形はいくらですか？','二重手術の回復期間は？'] },
      { kw:'鼻整形 ダウンタイム 短い',  aeoQ:['鼻フィラーのダウンタイムは？'] },
    ],
  },
  competitors: [
    { name:'바노바기',     strength:'브랜드 인지도', weakness:'가격대 높음', ourEdge:'일본어 대응·MEDIFLOW' },
    { name:'id병원',       strength:'규모·실적',    weakness:'개인 대응 부족', ourEdge:'담당의 1:1 상담' },
    { name:'디에이성형외과', strength:'코 성형 전문',  weakness:'다국어 미흡', ourEdge:'다언어 코디네이터' },
  ],
  performance: {
